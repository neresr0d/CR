...
<body>
    ...
    <section class="d-flex justify-content-center">
        <section class="m-3 w-50 d-flex justify-content-center" >
            <form action="/SQL/CRUD/crud_estudo/controllers/animal_edit_controller.php" method= "post">
                <input type="hidden" name="id" value="<?= $animal->getId() ?>">


                <div class="mb-3">
                    <label for="nome" class="form-label">Nome</label>
                    <input type="text" class="form-control" id="nome" name= "nome" value="<?= $animal->getNome(); ?>">
                </div>
